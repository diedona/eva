...
namespace Eva.Platform.Middlewares;

public sealed class TraceIdMiddleware
{
    private const string TRACE_HEADER = "traceparent";
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        if (context.Request.Headers.TryGetValue(TRACE_HEADER, out var incomingTraceId))
        {
            try
            {
        ...
        context.Response.Headers.Append(TRACE_HEADER, traceId);
